...
#> ./data/hpc_dataset 27413 FALSE  666 2015-03-07 19:39:21 2015-03-04 10:30:41 2015-03-04 10:30:41  no
##
...
##
myPNGfile<-"plot3.png"
png(filename=myPNGfile,width=480,height=480) ## open png device for plot3.png 480x480 pix

with(hpc,{plot(Time,Sub_metering_1,
              col="black",
              xlab="",
         ...
         legend("topright",  
              seg.len=2,
              col=c("black","red","blue"), # order to follow submeter  
              lty="solid",
...
#>           size isdir mode               mtime               ctime               atime exe
#> plot3.png 3959 FALSE  666 2015-03-07 19:39:21 2015-03-03 21:31:01 2015-03-03 21:31:01  no
##
