## Plot #4 Multiple plots arranged in 2x2 matrix
##
## This R code to generate plot4.PNG file as illustrated and described in assignment
##
...
##         plot4.png plot file and display in the Plot console
##
...
##         a copy of the hpc data.frame saved as hpc_dataset file in the ./data subdirectory
##         plot4.png 480x480 pix with white bg and (2x2) frames representing
##              plot1, Global Active Power vs Time, as described in plot2.R
##              plot2, Voltage vs Time, black color lineplot, x-axis annotated datetime
...
with(hpc, plot(Time,Global_active_power,
               type="l",
               xlab="",
               ylab="Global Active Power"))     # note y-lab shortened
##
## Plot#2 - Voltage vs Time (labeled x-axis as datetime)
##
with(hpc, plot(Time, Voltage,
               type="l",
               ylab="Voltage",
               xlab="datetime",
               col="black"))
